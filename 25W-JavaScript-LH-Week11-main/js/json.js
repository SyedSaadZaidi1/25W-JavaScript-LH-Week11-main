...
const url = "https://syedsaadzaidi1.github.io/25W-JavaScript-LH-Week11-main/25W-JavaScript-LH-Week11-main/js/icecream.json";
...
p.textContent = `Head Office: ${jsonBody.headOffice}, est, ${jsonBody.established} - Active ${(json.active ? "Yes" : "No")};`
